...
```
Here is our chance to highlight some of the most important people in our lives. These people have been there through tough times and great times. These are the friends we wish to highlight today and ask you, if you see them around, to thank them for being such an important part of the path that has lead us to where we are today. 
...
```{r}
paths <- c(  "images/Luna_1.jpg", "images/Luna_2.jpeg")
